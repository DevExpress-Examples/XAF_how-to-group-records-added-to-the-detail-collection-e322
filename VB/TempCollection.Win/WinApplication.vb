...
Namespace TempCollection.Win
	Partial Public Class TempCollectionWindowsFormsApplication
		...
		Private Sub TempCollectionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
